 ...
 */
class Criterias extends ActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'criteriaValues' => array(self::HAS_MANY, 'CriteriaValues', 'criteria_id'),
			'projectCriteriases' => array(self::HAS_MANY, 'ProjectCriterias', 'criterias_id'),
		);
	}
