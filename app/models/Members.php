...
class Members extends ActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('created', 'safe'),
			array('id, user_id, full_name, email, phone, created, git_nickname, vk_link', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'commits' => array(self::HAS_MANY, 'Commits', 'member_id'),
			'events' => array(self::MANY_MANY, 'Events', 'event_members(members_id, event_id)'),
			'user' => array(self::BELONGS_TO, 'Users', 'user_id'),
			'projects' => array(self::HAS_MANY, 'Projects', 'owner_id'),
			'teams' => array(self::MANY_MANY, 'Teams', 'team_members(members_id, team_id)'),
		);
	}
